...
function updateAncestorTraversalFlagsOnAttach(lView) {
  var _a, _b;
  (_a = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a.notify(1);
...
function markAncestorsForTraversal(lView) {
  var _a;
  (_a = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a.notify();
...
function cleanupDehydratedI18nNodes(lView) {
  var _a;
  const i18nNodes = (_a = lView[HYDRATION]) == null ? void 0 : _a.i18nNodes;
  if (i18nNodes) {
    const renderer = lView[RENDERER];
...
function shouldBeIgnoredByZone(applyArgs) {
  ...
  return ((_a = applyArgs[0].data) == null ? void 0 : _a["__ignore_ng_zone__"]) === true;
}
...
var AfterRenderCallback = class {
  constructor(phase, callbackFn) {
    ...
    this.errorHandler = inject(ErrorHandler, { optional: true });
    (_a = inject(ChangeDetectionScheduler, { optional: true })) == null ? void 0 : _a.notify(1);
  }
  invoke() {
    var _a;
    try {
...
var ContentChild = makePropDecorator("ContentChild", (selector, opts = {}) => ({ selector, first: true, isViewQuery: false, descendants: true, ...opts }), Query);
...
var ViewChild = makePropDecorator("ViewChild", (selector, opts) => ({ selector, first: true, isViewQuery: true, descendants: true, ...opts }), Query);
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-AQZNPZ6F.js.map
