...
import { NgModuleMeta, PipeMeta } from '@angular/compiler-cli/src/ngtsc/metadata';
...
import { PotentialDirective, PotentialImport, PotentialImportMode, PotentialPipe } from '@angular/compiler-cli/src/ngtsc/typecheck/api/scope';
