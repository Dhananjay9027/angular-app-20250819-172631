...
import { DefaultImportTracker, ImportRewriter, LocalCompilationExtraImportsTracker } from '@angular/compiler-cli/src/ngtsc/imports';
...
import { TraitCompiler } from '@angular/compiler-cli/src/ngtsc/transform/src/compilation';
