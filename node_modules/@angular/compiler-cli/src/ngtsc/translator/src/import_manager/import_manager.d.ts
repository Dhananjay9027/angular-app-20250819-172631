...
import { AliasImportDeclaration, ImportRewriter } from '@angular/compiler-cli/src/ngtsc/imports';
import { ImportGenerator, ImportRequest } from '@angular/compiler-cli/src/ngtsc/translator/src/api/import_generator';
